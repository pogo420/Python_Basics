...
class CustomJsonEncoder(JSONEncoder):
    def default(self, o: Any) -> Any:
        # if isinstance(o, (Person, Company, Address)):
        #     return o.__dict__  # editable objects as key(reference name)-value(object value).
        if isinstance(o, Person):
            return f"""{ {"object_type": ObjectType.Person, "name": o.name, "company": o.company, "address": o.address} }"""
...
if __name__ == '__main__':
    ...
    print(serialize)
    print(loads("""{"a": 34}""", cls=CustomJsonDecoder))
    print(loads(str(serialize), object_hook=object_hook))

    # print(person_.__dict__)
    # print(person_.__dir__())
